...
function AlertDialogAction({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Action>) {
  return <Button asChild variant="destructive"><AlertDialogPrimitive.Action className={className} {...props} /></Button>
}

function AlertDialogCancel({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Cancel>) {
  return <Button asChild variant="outline"><AlertDialogPrimitive.Cancel className={className} {...props} /></Button>
}
